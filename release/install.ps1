...
The output above says why. The commonest causes are no network access, or
a macOS older than 14 for yara (yara-x publishes no wheel for it). Run
this again without the switch to install everything else; the readiness
register then shows what the missing extra leaves out.
'@
    }
